...
const Profile = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={[{ backgroundColor: "#ff679d", flexDirection: "row", height: 50, alignItems: "center", paddingLeft: 10 }]}>
      ...
      <View style={[{ backgroundColor: "rgba(0,0,0,0.1)", width: "97%", height: 150, borderRadius: 20, margin: 5, flexDirection: "row" }]}>
        ...
        <View style={{ marginTop: 30 }}><Text style={[styles.text1, styles.textBlack, { marginBottom: 6 }]}>Hello User!</Text>
          ...
          <View style={[{ flexDirection: "row" }]}><Icon4 name="alert-circle-outline" color="#2e63e8" size={17} />
            ...
            <TouchableOpacity style={style1.mypagebutton}><Text style={{color:"white",fontSize:16,fontWeight:"bold"}}>My Page</Text></TouchableOpacity>
        </View>
      </View>

      <LinearGradient colors={['#ff679d', '#ff679d', 'rgba(255,255,255,0.1)']} style={{ margin: 5, borderRadius: 10 }} start={{ x: 0, y: 1 }}
        end={{ x: 1, y: 0 }} >
        <TouchableOpacity  style={style1.lineargradient}>
        <View style={style1.icons}>
        <Image source={require("../assets/images/refer.png")}  style={{height:35,width:35}}/>
        </View>
  
          <Text style={style1.box}>Refer and Earn Coins</Text>
          <View style={{marginLeft:"auto",  marginRight: 10 }}><Icon2 name="arrow-forward-ios" size={20} color="white" /></View>
        </TouchableOpacity>
      </LinearGradient>
      <LinearGradient colors={['#ff679d', '#ff679d', 'rgba(255,255,255,0.1)']} style={{ margin: 5, borderRadius: 10 }} start={{ x: 0, y: 1 }}
        end={{ x: 1, y: 0 }} >
      ...
      <LinearGradient colors={['#ff679d', '#ff679d', 'rgba(255,255,255,0.1)']} style={{ margin: 5, borderRadius: 10 }} start={{ x: 0, y: 1 }}
        ...
        <TouchableOpacity onPress={()=>navigation.navigate("Coins")}  style={style1.lineargradient}>
        <View style={style1.icons}>
      ...
      <LinearGradient colors={['#ff679d', '#ff679d', 'rgba(255,255,255,0.1)']} style={{ margin: 5, borderRadius: 10 }} start={{ x: 0, y: 1 }}
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Setting")}  style={style1.lineargradient}>
        <View style={style1.icons}>
        <Icon name="cog" size={25} color="white" />
        </View>
        
          <Text style={style1.box}>Settings</Text>
          <Icon2 name="arrow-forward-ios" size={20} color="white"  style={{marginLeft:"auto"}}/>
        </TouchableOpacity>
      </LinearGradient>
      ...
      <LinearGradient colors={['#ff679d', '#ff679d', 'rgba(255,255,255,0.1)']} style={{ margin: 5, borderRadius: 10 }} start={{ x: 0, y: 1 }}
        ...
        <TouchableOpacity style={style1.lineargradient}>
        <View style={style1.icons}>  
         <Iconicons name="card" size={25} color="#55e798" /></View>
...
const style1 = StyleSheet.create({
 lineargradient:{
  height: 45, width: '98%', margin: 5, borderRadius: 5, flexDirection: "row",alignItems:"center",justifyContent:"space-between" 
 },
